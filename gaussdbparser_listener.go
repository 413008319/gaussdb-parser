...
// GaussdbParserListener is a complete listener for a parse tree produced by GaussdbParser.
type GaussdbParserListener interface {
	...
	// EnterHtap_action is called when entering the htap_action production.
	EnterHtap_action(c *Htap_actionContext)
	...
	// EnterColumn_length is called when entering the column_length production.
	EnterColumn_length(c *Column_lengthContext)
	...
	// EnterCreate_inc_mat_viewstmt is called when entering the create_inc_mat_viewstmt production.
	EnterCreate_inc_mat_viewstmt(c *Create_inc_mat_viewstmtContext)
	...
	// EnterCursorstmt is called when entering the cursorstmt production.
	EnterCursorstmt(c *CursorstmtContext)
	...
	// EnterGaussdb_opt_distribute is called when entering the gaussdb_opt_distribute production.
	EnterGaussdb_opt_distribute(c *Gaussdb_opt_distributeContext)
	...
	// EnterExplainplanstmt is called when entering the explainplanstmt production.
	EnterExplainplanstmt(c *ExplainplanstmtContext)
	...
	// EnterLockbucketsstmt is called when entering the lockbucketsstmt production.
	EnterLockbucketsstmt(c *LockbucketsstmtContext)

	// EnterMarkbucketsstmt is called when entering the markbucketsstmt production.
	EnterMarkbucketsstmt(c *MarkbucketsstmtContext)

	// EnterOpt_bucketlist is called when entering the opt_bucketlist production.
	EnterOpt_bucketlist(c *Opt_bucketlistContext)
	...
	// EnterGaussdb_create_generic_position is called when entering the gaussdb_create_generic_position production.
	EnterGaussdb_create_generic_position(c *Gaussdb_create_generic_positionContext)

	// EnterGaussdb_create_foreigntable_extend is called when entering the gaussdb_create_foreigntable_extend production.
	EnterGaussdb_create_foreigntable_extend(c *Gaussdb_create_foreigntable_extendContext)

	// EnterGaussdb_error_table_name is called when entering the gaussdb_error_table_name production.
	EnterGaussdb_error_table_name(c *Gaussdb_error_table_nameContext)

	// EnterGaussdb_nodenamelist is called when entering the gaussdb_nodenamelist production.
	EnterGaussdb_nodenamelist(c *Gaussdb_nodenamelistContext)

	// EnterGaussdb_groupname is called when entering the gaussdb_groupname production.
	EnterGaussdb_groupname(c *Gaussdb_groupnameContext)

	// EnterGaussdb_to_group is called when entering the gaussdb_to_group production.
	EnterGaussdb_to_group(c *Gaussdb_to_groupContext)

	// EnterGaussdb_limit_clause is called when entering the gaussdb_limit_clause production.
	EnterGaussdb_limit_clause(c *Gaussdb_limit_clauseContext)

	// EnterGaussdb_sort_clause is called when entering the gaussdb_sort_clause production.
	EnterGaussdb_sort_clause(c *Gaussdb_sort_clauseContext)

	// EnterGaussdb_from_clause is called when entering the gaussdb_from_clause production.
	EnterGaussdb_from_clause(c *Gaussdb_from_clauseContext)

	// EnterGaussdb_insert_when_clause is called when entering the gaussdb_insert_when_clause production.
	EnterGaussdb_insert_when_clause(c *Gaussdb_insert_when_clauseContext)

	// EnterGaussdb_truncate_table_partition is called when entering the gaussdb_truncate_table_partition production.
	EnterGaussdb_truncate_table_partition(c *Gaussdb_truncate_table_partitionContext)

	// EnterGaussdb_partition_extended_names is called when entering the gaussdb_partition_extended_names production.
	EnterGaussdb_partition_extended_names(c *Gaussdb_partition_extended_namesContext)

	// EnterGaussdb_partition_name is called when entering the gaussdb_partition_name production.
	EnterGaussdb_partition_name(c *Gaussdb_partition_nameContext)

	// EnterGaussdb_new_partition_name is called when entering the gaussdb_new_partition_name production.
	EnterGaussdb_new_partition_name(c *Gaussdb_new_partition_nameContext)

	// EnterGaussdb_partition_key_value is called when entering the gaussdb_partition_key_value production.
	EnterGaussdb_partition_key_value(c *Gaussdb_partition_key_valueContext)

	// EnterGaussdb_PURGE is called when entering the gaussdb_PURGE production.
	EnterGaussdb_PURGE(c *Gaussdb_PURGEContext)

	// EnterGaussdb_or_replace is called when entering the gaussdb_or_replace production.
	EnterGaussdb_or_replace(c *Gaussdb_or_replaceContext)

	// EnterGaussdb_index_name is called when entering the gaussdb_index_name production.
	EnterGaussdb_index_name(c *Gaussdb_index_nameContext)

	// EnterGaussdb_comment_list is called when entering the gaussdb_comment_list production.
	EnterGaussdb_comment_list(c *Gaussdb_comment_listContext)

	// EnterGaussdb_comment is called when entering the gaussdb_comment production.
	EnterGaussdb_comment(c *Gaussdb_commentContext)

	// EnterGaussdb_alter_index_ops_set is called when entering the gaussdb_alter_index_ops_set production.
	EnterGaussdb_alter_index_ops_set(c *Gaussdb_alter_index_ops_setContext)

	// EnterGaussdb_rebuild_clause is called when entering the gaussdb_rebuild_clause production.
	EnterGaussdb_rebuild_clause(c *Gaussdb_rebuild_clauseContext)

	// EnterGaussdb_alter_index_partitioning is called when entering the gaussdb_alter_index_partitioning production.
	EnterGaussdb_alter_index_partitioning(c *Gaussdb_alter_index_partitioningContext)

	// EnterGaussdb_modify_index_partition is called when entering the gaussdb_modify_index_partition production.
	EnterGaussdb_modify_index_partition(c *Gaussdb_modify_index_partitionContext)

	// EnterGaussdb_rename_index_partition is called when entering the gaussdb_rename_index_partition production.
	EnterGaussdb_rename_index_partition(c *Gaussdb_rename_index_partitionContext)

	// EnterGaussdb_move_index_partition is called when entering the gaussdb_move_index_partition production.
	EnterGaussdb_move_index_partition(c *Gaussdb_move_index_partitionContext)

	// EnterGaussdb_online is called when entering the gaussdb_online production.
	EnterGaussdb_online(c *Gaussdb_onlineContext)

	// EnterGaussdb_index_partition_name is called when entering the gaussdb_index_partition_name production.
	EnterGaussdb_index_partition_name(c *Gaussdb_index_partition_nameContext)

	// EnterGaussdb_partition_value is called when entering the gaussdb_partition_value production.
	EnterGaussdb_partition_value(c *Gaussdb_partition_valueContext)

	// EnterGaussdb_index_partition_tablespace is called when entering the gaussdb_index_partition_tablespace production.
	EnterGaussdb_index_partition_tablespace(c *Gaussdb_index_partition_tablespaceContext)

	// EnterGaussdb_index_partition_list is called when entering the gaussdb_index_partition_list production.
	EnterGaussdb_index_partition_list(c *Gaussdb_index_partition_listContext)

	// EnterGaussdb_index_partition is called when entering the gaussdb_index_partition production.
	EnterGaussdb_index_partition(c *Gaussdb_index_partitionContext)

	// EnterGaussdb_partition_value_list is called when entering the gaussdb_partition_value_list production.
	EnterGaussdb_partition_value_list(c *Gaussdb_partition_value_listContext)

	// EnterGaussdb_index_subpartition_list is called when entering the gaussdb_index_subpartition_list production.
	EnterGaussdb_index_subpartition_list(c *Gaussdb_index_subpartition_listContext)

	// EnterGaussdb_index_subppartition is called when entering the gaussdb_index_subppartition production.
	EnterGaussdb_index_subppartition(c *Gaussdb_index_subppartitionContext)

	// EnterGaussdb_connect_clause is called when entering the gaussdb_connect_clause production.
	EnterGaussdb_connect_clause(c *Gaussdb_connect_clauseContext)

	// EnterGaussdb_engine_list is called when entering the gaussdb_engine_list production.
	EnterGaussdb_engine_list(c *Gaussdb_engine_listContext)

	// EnterGaussdb_engine_item is called when entering the gaussdb_engine_item production.
	EnterGaussdb_engine_item(c *Gaussdb_engine_itemContext)

	// EnterGaussdb_table_option_list is called when entering the gaussdb_table_option_list production.
	EnterGaussdb_table_option_list(c *Gaussdb_table_option_listContext)

	// EnterGaussdb_table_option is called when entering the gaussdb_table_option production.
	EnterGaussdb_table_option(c *Gaussdb_table_optionContext)

	// EnterGaussdb_htap_option is called when entering the gaussdb_htap_option production.
	EnterGaussdb_htap_option(c *Gaussdb_htap_optionContext)

	// EnterGaussdb_distribute is called when entering the gaussdb_distribute production.
	EnterGaussdb_distribute(c *Gaussdb_distributeContext)

	// EnterGaussdb_slice_less_than_item_list is called when entering the gaussdb_slice_less_than_item_list production.
	EnterGaussdb_slice_less_than_item_list(c *Gaussdb_slice_less_than_item_listContext)

	// EnterGaussdb_slice_less_than_item is called when entering the gaussdb_slice_less_than_item production.
	EnterGaussdb_slice_less_than_item(c *Gaussdb_slice_less_than_itemContext)

	// EnterGaussdb_slice_start_end_item_list is called when entering the gaussdb_slice_start_end_item_list production.
	EnterGaussdb_slice_start_end_item_list(c *Gaussdb_slice_start_end_item_listContext)

	// EnterGaussdb_slice_start_end_item is called when entering the gaussdb_slice_start_end_item production.
	EnterGaussdb_slice_start_end_item(c *Gaussdb_slice_start_end_itemContext)

	// EnterGaussdb_slice_values_item_list is called when entering the gaussdb_slice_values_item_list production.
	EnterGaussdb_slice_values_item_list(c *Gaussdb_slice_values_item_listContext)

	// EnterGaussdb_slice_values_item_item is called when entering the gaussdb_slice_values_item_item production.
	EnterGaussdb_slice_values_item_item(c *Gaussdb_slice_values_item_itemContext)

	// EnterGaussdb_ilm_add_policy is called when entering the gaussdb_ilm_add_policy production.
	EnterGaussdb_ilm_add_policy(c *Gaussdb_ilm_add_policyContext)
	...
	// EnterPlsql_body is called when entering the plsql_body production.
	EnterPlsql_body(c *Plsql_bodyContext)
	...
	// EnterPlsql_statement is called when entering the plsql_statement production.
	EnterPlsql_statement(c *Plsql_statementContext)
	...
	// EnterTrigger_anonymous_block is called when entering the trigger_anonymous_block production.
	EnterTrigger_anonymous_block(c *Trigger_anonymous_blockContext)
	...
	// EnterGaussdb_cleanconnection is called when entering the gaussdb_cleanconnection production.
	EnterGaussdb_cleanconnection(c *Gaussdb_cleanconnectionContext)

	// EnterPolicy_name is called when entering the policy_name production.
	EnterPolicy_name(c *Policy_nameContext)

	// EnterGaussdb_createpolicystmt is called when entering the gaussdb_createpolicystmt production.
	EnterGaussdb_createpolicystmt(c *Gaussdb_createpolicystmtContext)

	// EnterGaussdb_audit_clause_list is called when entering the gaussdb_audit_clause_list production.
	EnterGaussdb_audit_clause_list(c *Gaussdb_audit_clause_listContext)

	// EnterPrivilege_access_audit_clause is called when entering the privilege_access_audit_clause production.
	EnterPrivilege_access_audit_clause(c *Privilege_access_audit_clauseContext)

	// EnterDdl_clause is called when entering the ddl_clause production.
	EnterDdl_clause(c *Ddl_clauseContext)

	// EnterResource_label_name is called when entering the resource_label_name production.
	EnterResource_label_name(c *Resource_label_nameContext)

	// EnterDml_clause is called when entering the dml_clause production.
	EnterDml_clause(c *Dml_clauseContext)

	// EnterFilter_group_clause is called when entering the filter_group_clause production.
	EnterFilter_group_clause(c *Filter_group_clauseContext)

	// EnterFilter_type_list is called when entering the filter_type_list production.
	EnterFilter_type_list(c *Filter_type_listContext)

	// EnterFilter_type is called when entering the filter_type production.
	EnterFilter_type(c *Filter_typeContext)

	// EnterFilter_value_list is called when entering the filter_value_list production.
	EnterFilter_value_list(c *Filter_value_listContext)

	// EnterFilter_value is called when entering the filter_value production.
	EnterFilter_value(c *Filter_valueContext)

	// EnterGaussdb_createbarrierstmt is called when entering the gaussdb_createbarrierstmt production.
	EnterGaussdb_createbarrierstmt(c *Gaussdb_createbarrierstmtContext)

	// EnterGaussdb_create_client_master_key is called when entering the gaussdb_create_client_master_key production.
	EnterGaussdb_create_client_master_key(c *Gaussdb_create_client_master_keyContext)

	// EnterClient_master_key_name is called when entering the client_master_key_name production.
	EnterClient_master_key_name(c *Client_master_key_nameContext)

	// EnterClient_master_key_list is called when entering the client_master_key_list production.
	EnterClient_master_key_list(c *Client_master_key_listContext)

	// EnterClient_master_key is called when entering the client_master_key production.
	EnterClient_master_key(c *Client_master_keyContext)

	// EnterGaussdb_create_column_encryption_key is called when entering the gaussdb_create_column_encryption_key production.
	EnterGaussdb_create_column_encryption_key(c *Gaussdb_create_column_encryption_keyContext)

	// EnterColumn_encryption_key_name is called when entering the column_encryption_key_name production.
	EnterColumn_encryption_key_name(c *Column_encryption_key_nameContext)

	// EnterColumn_encryption_key_list is called when entering the column_encryption_key_list production.
	EnterColumn_encryption_key_list(c *Column_encryption_key_listContext)

	// EnterColumn_encryption_key is called when entering the column_encryption_key production.
	EnterColumn_encryption_key(c *Column_encryption_keyContext)

	// EnterGaussdb_create_database_link is called when entering the gaussdb_create_database_link production.
	EnterGaussdb_create_database_link(c *Gaussdb_create_database_linkContext)
	...
	// EnterDatabase_link_using is called when entering the database_link_using production.
	EnterDatabase_link_using(c *Database_link_usingContext)
	...
	// EnterGaussdb_create_masking_policy is called when entering the gaussdb_create_masking_policy production.
	EnterGaussdb_create_masking_policy(c *Gaussdb_create_masking_policyContext)

	// EnterMasking_clause_list is called when entering the masking_clause_list production.
	EnterMasking_clause_list(c *Masking_clause_listContext)

	// EnterMasking_clause is called when entering the masking_clause production.
	EnterMasking_clause(c *Masking_clauseContext)

	// EnterMasking_function is called when entering the masking_function production.
	EnterMasking_function(c *Masking_functionContext)

	// EnterPolicy_filter_clause is called when entering the policy_filter_clause production.
	EnterPolicy_filter_clause(c *Policy_filter_clauseContext)

	// EnterGaussdb_create_node is called when entering the gaussdb_create_node production.
	EnterGaussdb_create_node(c *Gaussdb_create_nodeContext)

	// EnterGaussdb_nodename is called when entering the gaussdb_nodename production.
	EnterGaussdb_nodename(c *Gaussdb_nodenameContext)

	// EnterGaussdb_create_node_group is called when entering the gaussdb_create_node_group production.
	EnterGaussdb_create_node_group(c *Gaussdb_create_node_groupContext)

	// EnterGaussdb_bucketnumber is called when entering the gaussdb_bucketnumber production.
	EnterGaussdb_bucketnumber(c *Gaussdb_bucketnumberContext)

	// EnterGaussdb_create_resource_pool is called when entering the gaussdb_create_resource_pool production.
	EnterGaussdb_create_resource_pool(c *Gaussdb_create_resource_poolContext)

	// EnterGaussdb_resource_pool_name is called when entering the gaussdb_resource_pool_name production.
	EnterGaussdb_resource_pool_name(c *Gaussdb_resource_pool_nameContext)

	// EnterGaussdb_create_resource_label is called when entering the gaussdb_create_resource_label production.
	EnterGaussdb_create_resource_label(c *Gaussdb_create_resource_labelContext)

	// EnterLabel_item_list is called when entering the label_item_list production.
	EnterLabel_item_list(c *Label_item_listContext)

	// EnterLabel_item is called when entering the label_item production.
	EnterLabel_item(c *Label_itemContext)

	// EnterResource_path is called when entering the resource_path production.
	EnterResource_path(c *Resource_pathContext)

	// EnterResource_type is called when entering the resource_type production.
	EnterResource_type(c *Resource_typeContext)

	// EnterGaussdb_create_security_label is called when entering the gaussdb_create_security_label production.
	EnterGaussdb_create_security_label(c *Gaussdb_create_security_labelContext)

	// EnterGaussdb_create_synonym is called when entering the gaussdb_create_synonym production.
	EnterGaussdb_create_synonym(c *Gaussdb_create_synonymContext)

	// EnterSynonym_name is called when entering the synonym_name production.
	EnterSynonym_name(c *Synonym_nameContext)

	// EnterGaussdb_partition_less_than_item_list is called when entering the gaussdb_partition_less_than_item_list production.
	EnterGaussdb_partition_less_than_item_list(c *Gaussdb_partition_less_than_item_listContext)

	// EnterGaussdb_partition_less_than_item is called when entering the gaussdb_partition_less_than_item production.
	EnterGaussdb_partition_less_than_item(c *Gaussdb_partition_less_than_itemContext)

	// EnterGaussdb_partition_start_end_item_list is called when entering the gaussdb_partition_start_end_item_list production.
	EnterGaussdb_partition_start_end_item_list(c *Gaussdb_partition_start_end_item_listContext)

	// EnterGaussdb_partition_start_end_item is called when entering the gaussdb_partition_start_end_item production.
	EnterGaussdb_partition_start_end_item(c *Gaussdb_partition_start_end_itemContext)

	// EnterOpttablespace_list is called when entering the opttablespace_list production.
	EnterOpttablespace_list(c *Opttablespace_listContext)

	// EnterGaussdb_partition_hash_item is called when entering the gaussdb_partition_hash_item production.
	EnterGaussdb_partition_hash_item(c *Gaussdb_partition_hash_itemContext)

	// EnterGaussdb_partition_list_item is called when entering the gaussdb_partition_list_item production.
	EnterGaussdb_partition_list_item(c *Gaussdb_partition_list_itemContext)

	// EnterGaussdb_create_weak_password_dic is called when entering the gaussdb_create_weak_password_dic production.
	EnterGaussdb_create_weak_password_dic(c *Gaussdb_create_weak_password_dicContext)

	// EnterGaussdb_purge_stmt is called when entering the gaussdb_purge_stmt production.
	EnterGaussdb_purge_stmt(c *Gaussdb_purge_stmtContext)

	// EnterGaussdb_replacestmt is called when entering the gaussdb_replacestmt production.
	EnterGaussdb_replacestmt(c *Gaussdb_replacestmtContext)

	// EnterGaussdb_shutdown_stmt is called when entering the gaussdb_shutdown_stmt production.
	EnterGaussdb_shutdown_stmt(c *Gaussdb_shutdown_stmtContext)

	// EnterGaussdb_show_events_stmt is called when entering the gaussdb_show_events_stmt production.
	EnterGaussdb_show_events_stmt(c *Gaussdb_show_events_stmtContext)
	...
	// ExitHtap_action is called when exiting the htap_action production.
	ExitHtap_action(c *Htap_actionContext)
	...
	// ExitColumn_length is called when exiting the column_length production.
	ExitColumn_length(c *Column_lengthContext)
	...
	// ExitCreate_inc_mat_viewstmt is called when exiting the create_inc_mat_viewstmt production.
	ExitCreate_inc_mat_viewstmt(c *Create_inc_mat_viewstmtContext)
	...
	// ExitCursorstmt is called when exiting the cursorstmt production.
	ExitCursorstmt(c *CursorstmtContext)
	...
	// ExitGaussdb_opt_distribute is called when exiting the gaussdb_opt_distribute production.
	ExitGaussdb_opt_distribute(c *Gaussdb_opt_distributeContext)
	...
	// ExitExplainplanstmt is called when exiting the explainplanstmt production.
	ExitExplainplanstmt(c *ExplainplanstmtContext)
	...
	// ExitLockbucketsstmt is called when exiting the lockbucketsstmt production.
	ExitLockbucketsstmt(c *LockbucketsstmtContext)

	// ExitMarkbucketsstmt is called when exiting the markbucketsstmt production.
	ExitMarkbucketsstmt(c *MarkbucketsstmtContext)

	// ExitOpt_bucketlist is called when exiting the opt_bucketlist production.
	ExitOpt_bucketlist(c *Opt_bucketlistContext)
	...
	// ExitGaussdb_create_generic_position is called when exiting the gaussdb_create_generic_position production.
	ExitGaussdb_create_generic_position(c *Gaussdb_create_generic_positionContext)

	// ExitGaussdb_create_foreigntable_extend is called when exiting the gaussdb_create_foreigntable_extend production.
	ExitGaussdb_create_foreigntable_extend(c *Gaussdb_create_foreigntable_extendContext)

	// ExitGaussdb_error_table_name is called when exiting the gaussdb_error_table_name production.
	ExitGaussdb_error_table_name(c *Gaussdb_error_table_nameContext)

	// ExitGaussdb_nodenamelist is called when exiting the gaussdb_nodenamelist production.
	ExitGaussdb_nodenamelist(c *Gaussdb_nodenamelistContext)

	// ExitGaussdb_groupname is called when exiting the gaussdb_groupname production.
	ExitGaussdb_groupname(c *Gaussdb_groupnameContext)

	// ExitGaussdb_to_group is called when exiting the gaussdb_to_group production.
	ExitGaussdb_to_group(c *Gaussdb_to_groupContext)

	// ExitGaussdb_limit_clause is called when exiting the gaussdb_limit_clause production.
	ExitGaussdb_limit_clause(c *Gaussdb_limit_clauseContext)

	// ExitGaussdb_sort_clause is called when exiting the gaussdb_sort_clause production.
	ExitGaussdb_sort_clause(c *Gaussdb_sort_clauseContext)

	// ExitGaussdb_from_clause is called when exiting the gaussdb_from_clause production.
	ExitGaussdb_from_clause(c *Gaussdb_from_clauseContext)

	// ExitGaussdb_insert_when_clause is called when exiting the gaussdb_insert_when_clause production.
	ExitGaussdb_insert_when_clause(c *Gaussdb_insert_when_clauseContext)

	// ExitGaussdb_truncate_table_partition is called when exiting the gaussdb_truncate_table_partition production.
	ExitGaussdb_truncate_table_partition(c *Gaussdb_truncate_table_partitionContext)

	// ExitGaussdb_partition_extended_names is called when exiting the gaussdb_partition_extended_names production.
	ExitGaussdb_partition_extended_names(c *Gaussdb_partition_extended_namesContext)

	// ExitGaussdb_partition_name is called when exiting the gaussdb_partition_name production.
	ExitGaussdb_partition_name(c *Gaussdb_partition_nameContext)

	// ExitGaussdb_new_partition_name is called when exiting the gaussdb_new_partition_name production.
	ExitGaussdb_new_partition_name(c *Gaussdb_new_partition_nameContext)

	// ExitGaussdb_partition_key_value is called when exiting the gaussdb_partition_key_value production.
	ExitGaussdb_partition_key_value(c *Gaussdb_partition_key_valueContext)

	// ExitGaussdb_PURGE is called when exiting the gaussdb_PURGE production.
	ExitGaussdb_PURGE(c *Gaussdb_PURGEContext)

	// ExitGaussdb_or_replace is called when exiting the gaussdb_or_replace production.
	ExitGaussdb_or_replace(c *Gaussdb_or_replaceContext)

	// ExitGaussdb_index_name is called when exiting the gaussdb_index_name production.
	ExitGaussdb_index_name(c *Gaussdb_index_nameContext)

	// ExitGaussdb_comment_list is called when exiting the gaussdb_comment_list production.
	ExitGaussdb_comment_list(c *Gaussdb_comment_listContext)

	// ExitGaussdb_comment is called when exiting the gaussdb_comment production.
	ExitGaussdb_comment(c *Gaussdb_commentContext)

	// ExitGaussdb_alter_index_ops_set is called when exiting the gaussdb_alter_index_ops_set production.
	ExitGaussdb_alter_index_ops_set(c *Gaussdb_alter_index_ops_setContext)

	// ExitGaussdb_rebuild_clause is called when exiting the gaussdb_rebuild_clause production.
	ExitGaussdb_rebuild_clause(c *Gaussdb_rebuild_clauseContext)

	// ExitGaussdb_alter_index_partitioning is called when exiting the gaussdb_alter_index_partitioning production.
	ExitGaussdb_alter_index_partitioning(c *Gaussdb_alter_index_partitioningContext)

	// ExitGaussdb_modify_index_partition is called when exiting the gaussdb_modify_index_partition production.
	ExitGaussdb_modify_index_partition(c *Gaussdb_modify_index_partitionContext)

	// ExitGaussdb_rename_index_partition is called when exiting the gaussdb_rename_index_partition production.
	ExitGaussdb_rename_index_partition(c *Gaussdb_rename_index_partitionContext)

	// ExitGaussdb_move_index_partition is called when exiting the gaussdb_move_index_partition production.
	ExitGaussdb_move_index_partition(c *Gaussdb_move_index_partitionContext)

	// ExitGaussdb_online is called when exiting the gaussdb_online production.
	ExitGaussdb_online(c *Gaussdb_onlineContext)

	// ExitGaussdb_index_partition_name is called when exiting the gaussdb_index_partition_name production.
	ExitGaussdb_index_partition_name(c *Gaussdb_index_partition_nameContext)

	// ExitGaussdb_partition_value is called when exiting the gaussdb_partition_value production.
	ExitGaussdb_partition_value(c *Gaussdb_partition_valueContext)

	// ExitGaussdb_index_partition_tablespace is called when exiting the gaussdb_index_partition_tablespace production.
	ExitGaussdb_index_partition_tablespace(c *Gaussdb_index_partition_tablespaceContext)

	// ExitGaussdb_index_partition_list is called when exiting the gaussdb_index_partition_list production.
	ExitGaussdb_index_partition_list(c *Gaussdb_index_partition_listContext)

	// ExitGaussdb_index_partition is called when exiting the gaussdb_index_partition production.
	ExitGaussdb_index_partition(c *Gaussdb_index_partitionContext)

	// ExitGaussdb_partition_value_list is called when exiting the gaussdb_partition_value_list production.
	ExitGaussdb_partition_value_list(c *Gaussdb_partition_value_listContext)

	// ExitGaussdb_index_subpartition_list is called when exiting the gaussdb_index_subpartition_list production.
	ExitGaussdb_index_subpartition_list(c *Gaussdb_index_subpartition_listContext)

	// ExitGaussdb_index_subppartition is called when exiting the gaussdb_index_subppartition production.
	ExitGaussdb_index_subppartition(c *Gaussdb_index_subppartitionContext)

	// ExitGaussdb_connect_clause is called when exiting the gaussdb_connect_clause production.
	ExitGaussdb_connect_clause(c *Gaussdb_connect_clauseContext)

	// ExitGaussdb_engine_list is called when exiting the gaussdb_engine_list production.
	ExitGaussdb_engine_list(c *Gaussdb_engine_listContext)

	// ExitGaussdb_engine_item is called when exiting the gaussdb_engine_item production.
	ExitGaussdb_engine_item(c *Gaussdb_engine_itemContext)

	// ExitGaussdb_table_option_list is called when exiting the gaussdb_table_option_list production.
	ExitGaussdb_table_option_list(c *Gaussdb_table_option_listContext)

	// ExitGaussdb_table_option is called when exiting the gaussdb_table_option production.
	ExitGaussdb_table_option(c *Gaussdb_table_optionContext)

	// ExitGaussdb_htap_option is called when exiting the gaussdb_htap_option production.
	ExitGaussdb_htap_option(c *Gaussdb_htap_optionContext)

	// ExitGaussdb_distribute is called when exiting the gaussdb_distribute production.
	ExitGaussdb_distribute(c *Gaussdb_distributeContext)

	// ExitGaussdb_slice_less_than_item_list is called when exiting the gaussdb_slice_less_than_item_list production.
	ExitGaussdb_slice_less_than_item_list(c *Gaussdb_slice_less_than_item_listContext)

	// ExitGaussdb_slice_less_than_item is called when exiting the gaussdb_slice_less_than_item production.
	ExitGaussdb_slice_less_than_item(c *Gaussdb_slice_less_than_itemContext)

	// ExitGaussdb_slice_start_end_item_list is called when exiting the gaussdb_slice_start_end_item_list production.
	ExitGaussdb_slice_start_end_item_list(c *Gaussdb_slice_start_end_item_listContext)

	// ExitGaussdb_slice_start_end_item is called when exiting the gaussdb_slice_start_end_item production.
	ExitGaussdb_slice_start_end_item(c *Gaussdb_slice_start_end_itemContext)

	// ExitGaussdb_slice_values_item_list is called when exiting the gaussdb_slice_values_item_list production.
	ExitGaussdb_slice_values_item_list(c *Gaussdb_slice_values_item_listContext)

	// ExitGaussdb_slice_values_item_item is called when exiting the gaussdb_slice_values_item_item production.
	ExitGaussdb_slice_values_item_item(c *Gaussdb_slice_values_item_itemContext)

	// ExitGaussdb_ilm_add_policy is called when exiting the gaussdb_ilm_add_policy production.
	ExitGaussdb_ilm_add_policy(c *Gaussdb_ilm_add_policyContext)
	...
	// ExitPlsql_body is called when exiting the plsql_body production.
	ExitPlsql_body(c *Plsql_bodyContext)
	...
	// ExitPlsql_statement is called when exiting the plsql_statement production.
	ExitPlsql_statement(c *Plsql_statementContext)
	...
	// ExitTrigger_anonymous_block is called when exiting the trigger_anonymous_block production.
	ExitTrigger_anonymous_block(c *Trigger_anonymous_blockContext)
	...
	// ExitGaussdb_cleanconnection is called when exiting the gaussdb_cleanconnection production.
	ExitGaussdb_cleanconnection(c *Gaussdb_cleanconnectionContext)

	// ExitPolicy_name is called when exiting the policy_name production.
	ExitPolicy_name(c *Policy_nameContext)

	// ExitGaussdb_createpolicystmt is called when exiting the gaussdb_createpolicystmt production.
	ExitGaussdb_createpolicystmt(c *Gaussdb_createpolicystmtContext)

	// ExitGaussdb_audit_clause_list is called when exiting the gaussdb_audit_clause_list production.
	ExitGaussdb_audit_clause_list(c *Gaussdb_audit_clause_listContext)

	// ExitPrivilege_access_audit_clause is called when exiting the privilege_access_audit_clause production.
	ExitPrivilege_access_audit_clause(c *Privilege_access_audit_clauseContext)

	// ExitDdl_clause is called when exiting the ddl_clause production.
	ExitDdl_clause(c *Ddl_clauseContext)

	// ExitResource_label_name is called when exiting the resource_label_name production.
	ExitResource_label_name(c *Resource_label_nameContext)

	// ExitDml_clause is called when exiting the dml_clause production.
	ExitDml_clause(c *Dml_clauseContext)

	// ExitFilter_group_clause is called when exiting the filter_group_clause production.
	ExitFilter_group_clause(c *Filter_group_clauseContext)

	// ExitFilter_type_list is called when exiting the filter_type_list production.
	ExitFilter_type_list(c *Filter_type_listContext)

	// ExitFilter_type is called when exiting the filter_type production.
	ExitFilter_type(c *Filter_typeContext)

	// ExitFilter_value_list is called when exiting the filter_value_list production.
	ExitFilter_value_list(c *Filter_value_listContext)

	// ExitFilter_value is called when exiting the filter_value production.
	ExitFilter_value(c *Filter_valueContext)

	// ExitGaussdb_createbarrierstmt is called when exiting the gaussdb_createbarrierstmt production.
	ExitGaussdb_createbarrierstmt(c *Gaussdb_createbarrierstmtContext)

	// ExitGaussdb_create_client_master_key is called when exiting the gaussdb_create_client_master_key production.
	ExitGaussdb_create_client_master_key(c *Gaussdb_create_client_master_keyContext)

	// ExitClient_master_key_name is called when exiting the client_master_key_name production.
	ExitClient_master_key_name(c *Client_master_key_nameContext)

	// ExitClient_master_key_list is called when exiting the client_master_key_list production.
	ExitClient_master_key_list(c *Client_master_key_listContext)

	// ExitClient_master_key is called when exiting the client_master_key production.
	ExitClient_master_key(c *Client_master_keyContext)

	// ExitGaussdb_create_column_encryption_key is called when exiting the gaussdb_create_column_encryption_key production.
	ExitGaussdb_create_column_encryption_key(c *Gaussdb_create_column_encryption_keyContext)

	// ExitColumn_encryption_key_name is called when exiting the column_encryption_key_name production.
	ExitColumn_encryption_key_name(c *Column_encryption_key_nameContext)

	// ExitColumn_encryption_key_list is called when exiting the column_encryption_key_list production.
	ExitColumn_encryption_key_list(c *Column_encryption_key_listContext)

	// ExitColumn_encryption_key is called when exiting the column_encryption_key production.
	ExitColumn_encryption_key(c *Column_encryption_keyContext)

	// ExitGaussdb_create_database_link is called when exiting the gaussdb_create_database_link production.
	ExitGaussdb_create_database_link(c *Gaussdb_create_database_linkContext)
	...
	// ExitDatabase_link_using is called when exiting the database_link_using production.
	ExitDatabase_link_using(c *Database_link_usingContext)
	...
	// ExitGaussdb_create_masking_policy is called when exiting the gaussdb_create_masking_policy production.
	ExitGaussdb_create_masking_policy(c *Gaussdb_create_masking_policyContext)

	// ExitMasking_clause_list is called when exiting the masking_clause_list production.
	ExitMasking_clause_list(c *Masking_clause_listContext)

	// ExitMasking_clause is called when exiting the masking_clause production.
	ExitMasking_clause(c *Masking_clauseContext)

	// ExitMasking_function is called when exiting the masking_function production.
	ExitMasking_function(c *Masking_functionContext)

	// ExitPolicy_filter_clause is called when exiting the policy_filter_clause production.
	ExitPolicy_filter_clause(c *Policy_filter_clauseContext)

	// ExitGaussdb_create_node is called when exiting the gaussdb_create_node production.
	ExitGaussdb_create_node(c *Gaussdb_create_nodeContext)

	// ExitGaussdb_nodename is called when exiting the gaussdb_nodename production.
	ExitGaussdb_nodename(c *Gaussdb_nodenameContext)

	// ExitGaussdb_create_node_group is called when exiting the gaussdb_create_node_group production.
	ExitGaussdb_create_node_group(c *Gaussdb_create_node_groupContext)

	// ExitGaussdb_bucketnumber is called when exiting the gaussdb_bucketnumber production.
	ExitGaussdb_bucketnumber(c *Gaussdb_bucketnumberContext)

	// ExitGaussdb_create_resource_pool is called when exiting the gaussdb_create_resource_pool production.
	ExitGaussdb_create_resource_pool(c *Gaussdb_create_resource_poolContext)

	// ExitGaussdb_resource_pool_name is called when exiting the gaussdb_resource_pool_name production.
	ExitGaussdb_resource_pool_name(c *Gaussdb_resource_pool_nameContext)

	// ExitGaussdb_create_resource_label is called when exiting the gaussdb_create_resource_label production.
	ExitGaussdb_create_resource_label(c *Gaussdb_create_resource_labelContext)

	// ExitLabel_item_list is called when exiting the label_item_list production.
	ExitLabel_item_list(c *Label_item_listContext)

	// ExitLabel_item is called when exiting the label_item production.
	ExitLabel_item(c *Label_itemContext)

	// ExitResource_path is called when exiting the resource_path production.
	ExitResource_path(c *Resource_pathContext)

	// ExitResource_type is called when exiting the resource_type production.
	ExitResource_type(c *Resource_typeContext)

	// ExitGaussdb_create_security_label is called when exiting the gaussdb_create_security_label production.
	ExitGaussdb_create_security_label(c *Gaussdb_create_security_labelContext)

	// ExitGaussdb_create_synonym is called when exiting the gaussdb_create_synonym production.
	ExitGaussdb_create_synonym(c *Gaussdb_create_synonymContext)

	// ExitSynonym_name is called when exiting the synonym_name production.
	ExitSynonym_name(c *Synonym_nameContext)

	// ExitGaussdb_partition_less_than_item_list is called when exiting the gaussdb_partition_less_than_item_list production.
	ExitGaussdb_partition_less_than_item_list(c *Gaussdb_partition_less_than_item_listContext)

	// ExitGaussdb_partition_less_than_item is called when exiting the gaussdb_partition_less_than_item production.
	ExitGaussdb_partition_less_than_item(c *Gaussdb_partition_less_than_itemContext)

	// ExitGaussdb_partition_start_end_item_list is called when exiting the gaussdb_partition_start_end_item_list production.
	ExitGaussdb_partition_start_end_item_list(c *Gaussdb_partition_start_end_item_listContext)

	// ExitGaussdb_partition_start_end_item is called when exiting the gaussdb_partition_start_end_item production.
	ExitGaussdb_partition_start_end_item(c *Gaussdb_partition_start_end_itemContext)

	// ExitOpttablespace_list is called when exiting the opttablespace_list production.
	ExitOpttablespace_list(c *Opttablespace_listContext)

	// ExitGaussdb_partition_hash_item is called when exiting the gaussdb_partition_hash_item production.
	ExitGaussdb_partition_hash_item(c *Gaussdb_partition_hash_itemContext)

	// ExitGaussdb_partition_list_item is called when exiting the gaussdb_partition_list_item production.
	ExitGaussdb_partition_list_item(c *Gaussdb_partition_list_itemContext)

	// ExitGaussdb_create_weak_password_dic is called when exiting the gaussdb_create_weak_password_dic production.
	ExitGaussdb_create_weak_password_dic(c *Gaussdb_create_weak_password_dicContext)

	// ExitGaussdb_purge_stmt is called when exiting the gaussdb_purge_stmt production.
	ExitGaussdb_purge_stmt(c *Gaussdb_purge_stmtContext)

	// ExitGaussdb_replacestmt is called when exiting the gaussdb_replacestmt production.
	ExitGaussdb_replacestmt(c *Gaussdb_replacestmtContext)

	// ExitGaussdb_shutdown_stmt is called when exiting the gaussdb_shutdown_stmt production.
	ExitGaussdb_shutdown_stmt(c *Gaussdb_shutdown_stmtContext)

	// ExitGaussdb_show_events_stmt is called when exiting the gaussdb_show_events_stmt production.
	ExitGaussdb_show_events_stmt(c *Gaussdb_show_events_stmtContext)
}
